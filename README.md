...
![Intro](docs/images/ms-driver_intro.png "Intro")
# Table of Contents
  ...
  * [BackEnd](#backend)
    *  [driver](#backend_driver)
        * [Environment variables](#backend_driver_env_vars)
        * [Event Sourcing](#backend_driver_eventsourcing)
        * [CronJobs](#backend_driver_cronjobs)
...
│   ├── driver                     => Micro-BackEnd responsible for ...
...
Note: You may find the GraphQL schema [here](api/emi-gateway/graphql/driver/schema.gql)
...
## driver <a name="backend_driver"></a>
...


### Environment variables <a name="backend_driver_env_vars"></a>
...
```
#### Notes: 
  * ENV VARS for development are [here](backend/driver/.env)
  * ENV VARS for production are [here](deployment/gke/deployment-driver.yaml)

### Event Sourcing <a name="backend_driver_eventsourcing"></a>
...
### CronJobs <a name="backend_driver_cronjobs"></a>
...
### 1. clone this repo  
   ```git clone https://github.com/nebulae-tpm/ms-driver.git```  
...
### 5. Compose FrontEnd
```
nebulae compose-ui development --shell-type=FUSE2_ANGULAR --shell-repo=https://github.com/nebulae-tpm/emi --frontend-id=emi --output-dir=/FULL_PATH_TO_REPO/ms-driver/playground/emi  --setup-file=/FULL_PATH_TO_REPO/ms-driver/etc/mfe-setup.json
```

### 6. Compose the API emi-gateway
```
nebulae compose-api development --api-type=NEBULAE_GATEWAY --api-repo=https://github.com/nebulae-tpm/emi-gateway --api-id=emi-gateway --output-dir=FULL_PATH_TO_REPO/ms-driver/playground/emi-gateway  --setup-file=FULL_PATH_TO_REPO/ms-driver/etc/mapi-setup.json
```
...
* set this key value to the **JWT_PUBLIC_KEY** atribute in the following files: *WORKING_FOLDER*/ms-driver/backend/driver/.env   *WORKING_FOLDER*/ms-driver/playground/emi-gateway/.env  
